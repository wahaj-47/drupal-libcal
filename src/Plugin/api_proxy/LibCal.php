...
namespace Drupal\libcal\Plugin\api_proxy;
 ...
 * @HttpApi(
 *   id = "libcal",
 *   label = @Translation("LibCal API"),
 *   description = @Translation("Proxies requests to the LibCal API."),
 *   serviceUrl = "https://lsu.libcal.com/api/1.1",
 * )
 */
final class LibCal extends HttpApiPluginBase
{
    ...
    private function getAccessToken(): string
    {
        ...
        if (!isset($data['access_token'])) {
            \Drupal::logger('libcal')->error('Access token missing in response: @resp', [
